...
const translations = {
  en: {
    ...
    sessionBookingNoSelfCancelTitle: "Cancellation not available",
    sessionBookingCancelViaTrainer: "To change or cancel a booking, contact your trainer.",
  ...
  pt: {
    ...
    sessionBookingNoSelfCancelTitle: "Cancelamento não disponível",
    sessionBookingCancelViaTrainer: "Para alterar ou cancelar uma inscrição, contacta o teu treinador.",
