...
const translations = {
  en: {
    ...
    shop: "Shop",
    shopPageDescription: "Log coffee and water servings for the gym shop by day.",
    ...
    shopLogDescription: "Choose a date, set counts, and save.",
    shopCoffeeLabel: "Coffee (cups)",
    shopWaterLabel: "Water (servings)",
    shopSave: "Save",
    shopSaveSuccess: "Saved",
    shopSaveFailed: "Could not save",
    shopLoadingDay: "Loading…",
    shopCoachDescription: "Recent coffee and water registrations from your students.",
    ...
    shopDeleteRegistrationConfirm:
      "Remove this coffee and water log for the selected day? The student can log again later.",
  ...
  pt: {
    ...
    shop: "Loja",
    shopPageDescription: "Registe café e água (porções) na loja do ginásio, por dia.",
    ...
    shopLogDescription: "Escolha a data, defina as quantidades e guarde.",
    shopCoffeeLabel: "Café (chávenas)",
    shopWaterLabel: "Água (porções)",
    shopSave: "Guardar",
    shopSaveSuccess: "Guardado",
    shopSaveFailed: "Não foi possível guardar",
    shopLoadingDay: "A carregar…",
    shopCoachDescription: "Registos recentes de café e água dos seus alunos.",
    ...
    shopDeleteRegistrationConfirm:
      "Remover este registo de café e água para o dia selecionado? O aluno pode voltar a registar depois.",
